    ...
    <section id="partners" className="py-20 md:py-32 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center items-center w-full">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 justify-center w-full max-w-4xl mx-auto">
              ...
              <div key={index} className="flex justify-center">
                ...
                <div className="w-full h-32 flex items-center justify-center mb-6 bg-slate-50 rounded-xl group-hover:bg-blue-50 transition-colors duration-300">
                  <img
                    src={partner.logo}
                    alt={partner.name}
                    className="h-28 w-auto object-contain transition-transform duration-300 group-hover:scale-115"
                  />
                </div>
